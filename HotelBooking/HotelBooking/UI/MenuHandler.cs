...
{
    public static void RunMainMenu(GuestService guestService, RoomService roomService, BookingService bookingService,
        ...
        while (true)
        {
            ...
            switch (input)
            {
                case "1":
                    ...
                    {
                        Console.WriteLine($"ID: {g.GuestId}, Navn: {g.Name}, Tlf: {g.ContactNumber}, Epost: {g.Email}");
                    }
                    break;
                ...
                case "2":
                    ...
                    {
                        Console.WriteLine($"ID: {r.RoomId}, Rom: {r.RoomNumber}, Type: {r.Type}, Pris: {r.Price} kr");
                    }
                    break;
